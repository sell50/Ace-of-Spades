...
public class Crazy8sGUI extends Application{
	...
	public Parent createWindow(Stage stage) throws Exception {
		...
		Image pileCards = new Image(new File("C:\\Users\\Katpa\\Documents\\GitHub\\Ace-of-Spades\\Cards\\" + crazy8s.discardPile[0].cardNumber + " of " + crazy8s.discardPile[0].cardSuit + ".png").toURI().toString(), 50, 80, false, true);
		...
		private void updateTopCard() 
		{
			...
			Image topCard = new Image(new File("C:\\Users\\Katpa\\Documents\\GitHub\\Ace-of-Spades\\Cards\\" + crazy8s.discardPile[0].cardNumber + " of " + crazy8s.discardPile[0].cardSuit + ".png").toURI().toString(), 50, 80, false, false); //loads the new image
